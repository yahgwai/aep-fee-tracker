...
### Cost Calculation (Same for All Methods):
...
1. **Volume Threshold**
   ...
   - Check total value in batch posting reports
   - Must be above threshold (filters out small chains with low volume)

2. **Cost vs Revenue Deviation**
   - Calculate deviation between revenue and estimated costs
...
- Analysis should cover two time periods:
  1. **Full period** - Complete historical data
  2. **Rolling 2-month window** - Recent activity analysis
- This dual approach helps identify both long-term patterns and recent deviations

### Output:

- Tool generates a simple report showing exchange rate deviations
- If both criteria are met: Contact chain owner to inform them they need to use a better pricing mechanism
