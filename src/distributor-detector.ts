...
export class DistributorDetector {
   ...
   * @returns DistributorInfo object if the event is a valid distributor creation, null otherwise
   */
  static parseDistributorCreation(
    ...
    try {
      ...
      // Validate that the data contains a valid address after the method selector
      try {
        ...
        // Data doesn't contain a valid address
        return null;
      }
